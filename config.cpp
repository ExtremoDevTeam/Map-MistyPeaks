...
class CfgPatches
{
	class Means_MistyPeaks
	{
		author = "HappyFeet";
		name = "Misty Peaks";
		url = "";
		requiredAddons[] = {"A3_Data_F","A3_Map_Data","A3_Roads_F","A3_Structures_F"};
		requiredVersion = 0.1;
		units[] = {};
		weapons[] = {};
	};
...
class CfgWorlds
{
	...
	class MistyPeaks: CAWorld
	{
		...
		worldId = 1337;
		description = "Misty Peaks";
		icon = "";
		worldName = "\MistyPeaks\MistyPeaks.wrp";
		previewVideo = "";
		pictureMap = "\MistyPeaks\data\loading.paa";
		pictureShot = "\MistyPeaks\data\picturemap.paa";
		plateFormat = "A#$-####";
		...
		newRoadsShape = "\MistyPeaks\Data\roads\roads.shp";
		...
		noDetailDist = 65;
		fullDetailDist = 20;
		midDetailTexture = "MistyPeaks\data\av_middle_mco.paa";
		...
		class Names
		{
			class EdenTrailsStatePark
			{
				name="Eden Trails State Park";
				position[]={4500.67,2360.14};
				type="CityCenter";
			...
			{
				name="North Jackson Town";
				position[]={8192.36,4802.99};
				type="NameCity";
			...
			{
				name="East Side Trailer Park";
				position[]={4663.70,3323.87};
				type="NameVillage";
			...
			{
				name="Misty Peaks Airfield";
				position[]={5379.20,1554.46};
				type="Airport";
			...
			{
				name="Big Joes Mining Facilities";
				position[]={4878.17,1174.52};
				type="NameVillage";
			...
			class DefaultKeyPoint11
			{
				name="Seaside Trailer Park";
				position[]={5995.34,2115.04};
				type="NameVillage";
			...
			{
				name="Misty Peaks Hilltop";
				position[]={5823.33,2759.44};
				type="Hill";
			...
			{
				name="Misty Peaks Cemetery";
				position[]={5006.83,3800.80};
				type="NameVillage";
			...
			{
				name="Misty Peaks Police Academy";
				position[]={5386.70,1841.25};
				type="NameVillage";
			...
			{
				name="Portsmith Township";
				position[]={6823.66,5778.96};
				type="NameCity";
			...
			{
				name="Portsmith Airfield";
				position[]={7122.54,7794.79};
				type="Airport";
			...
			{
				name="Misty Peaks Corrections";
				position[]={3450.64,6528.29};
				type="NameCity";
			...
			class DefaultKeyPoint20
			{
				name="Larry's Bay";
				position[]={7072.93,6117.26};
				type="CityCenter";
			...
			class DefaultKeyPoint21
			{
				name="North Point Island Airfield";
				position[]={5989.96,11134.33};
				type="Airport";
